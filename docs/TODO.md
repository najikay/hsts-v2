...
- [ ] E12.1 GradingService.autoGrade: per-question correctness (selection == correct_answer), weighted score, persist AUTO grade — *AutoGrader done: scoring rules (F8.1/C-8), unanswered = 0, pinned-version mismatch rejected, points-total-100 guard; 16 tests. Not ticked: **persist AUTO grade** needs the service + repository reads*
